...
//   }
// };
// backend/controllers/tenders.controller.js
import Notification from "../models/Notification.js";
import Tender from "../models/Tender.js";
import Application from "../models/Application.js";
import { sendTenderNotificationEmail } from "../utils/emails.js";
...
export const deleteTender = async (req, res) => {
  try {
    ...
    if (
      ...
      console.log("[deleteTender] Forbidden: user cannot delete this tender");
      return res.status(403).json({ message: "Forbidden" });
    }
...
// ------------------- CHECK TENDER VERIFICATION REQUIREMENT -------------------
export const checkTenderVerification = async (req, res) => {
  try {
    ...
    if (req.user && requiresVerification) {
      const VerificationCodeRequest = (await import("../models/VerificationCodeRequest.js")).default;
